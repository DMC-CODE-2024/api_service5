...
@Repository
public interface BrandRepository extends CrudRepository<DeviceBrand, Long>,
        JpaRepository<DeviceBrand, Long>, JpaSpecificationExecutor<DeviceBrand> {
...
//    List<DevBrandName> findDistinctTagsWithDescription();
  ...
  //  @Query(value = "SELECT NEW com.gl.ceir.config.model.app.DevBrandName(a.id, a.brandName) FROM DevBrandName a "
    ...
    public List<DeviceBrand> getBrandNameWithTop5New(String brand1, String brand2, String brand3, String brand4, String brand5);
   ...
   @Query(value = "select id , brand_name from dev_brand_name ORDER BY CASE "
    ...
    public List<DeviceBrand> getBrandNameWithTop5NewOracle(String brand1, String brand2, String brand3, String brand4, String brand5);
