package com.gl.mdr.feature.appanalyticsuploader.extras;
...
public enum FeaturesEnum {
    ...
    APP_ANALYTICS_EXPORT("APP_ANALYTICS_EXPORT", "App Analytics Uploader", "Export"), APP_ANALYTICS_VIEWALL("APP_ANALYTICS_VIEWALL", "App Analytics Uploader", "View All");
