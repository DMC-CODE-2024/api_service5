...
public class MobileDeviceRepositoryHistory {
	...
	@Column(name="trc_approved_status", length=50, columnDefinition="varchar(50) DEFAULT ''")
	...
	public String getTrcTypeApprovedBy() {
		return trcTypeApprovedBy;
	}

	public void setTrcTypeApprovedBy(String trcTypeApprovedBy) {
		this.trcTypeApprovedBy = trcTypeApprovedBy;
	}
	...
	public String toString() {
		return "MobileDeviceRepositoryHistory [id=" + id + ", updatedOn=" + updatedOn + ", mdrId=" + mdrId
				+ ", allocationDate=" + allocationDate + ", announceDate=" + announceDate + ", bandDetail=" + bandDetail
				+ ", batteryCapacity=" + batteryCapacity + ", batteryCharging=" + batteryCharging + ", batteryType="
				+ batteryType + ", bodyDimension=" + bodyDimension + ", bodyWeight=" + bodyWeight + ", brandName="
				+ brandName + ", colors=" + colors + ", commsBluetooth=" + commsBluetooth + ", commsGPS=" + commsGPS
				+ ", commsNFC=" + commsNFC + ", commsRadio=" + commsRadio + ", commsUSB=" + commsUSB + ", commsWLAN="
				+ commsWLAN + ", createdOn=" + createdOn + ", modifiedOn=" + modifiedOn + ", deviceId=" + deviceId
				+ ", marketingName=" + marketingName + ", manufacturer=" + manufacturer + ", manufacturingLocation="
				+ manufacturingLocation + ", modelName=" + modelName + ", oem=" + oem + ", organizationId="
				+ organizationId + ", deviceType=" + deviceType + ", imeiQuantity=" + imeiQuantity + ", simSlot="
				+ simSlot + ", esimSupport=" + esimSupport + ", softsimSupport=" + softsimSupport + ", simType="
				+ simType + ", os=" + os + ", osCurrentVersion=" + osCurrentVersion + ", osBaseVersion=" + osBaseVersion
				+ ", launchDate=" + launchDate + ", deviceStatus=" + deviceStatus + ", discontinueDate="
				+ discontinueDate + ", networkTechnologyGSM=" + networkTechnologyGSM + ", networkTechnologyCDMA="
				+ networkTechnologyCDMA + ", networkTechnologyEVDO=" + networkTechnologyEVDO + ", networkTechnologyLTE="
				+ networkTechnologyLTE + ", networkTechnology5G=" + networkTechnology5G + ", networkTechnology6G="
				+ networkTechnology6G + ", networkTechnology7G=" + networkTechnology7G + ", network2GBand="
				+ network2GBand + ", network3GBand=" + network3GBand + ", network4GBand=" + network4GBand
				+ ", network5GBand=" + network5GBand + ", network6GBand=" + network6GBand + ", network7GBand="
				+ network7GBand + ", networkSpeed=" + networkSpeed + ", displayType=" + displayType + ", displaySize="
				+ displaySize + ", displayResolution=" + displayResolution + ", displayProtection=" + displayProtection
				...
				+ ", deviceState=" + deviceState + ", userId=" + userId + ", remark=" + remark
				+ ", networkSpecificIdentifier=" + networkSpecificIdentifier + ", isTypeApproved=" + isTypeApproved
				+ ", trcApprovedStatus=" + trcApprovedStatus + ", approvedBy=" + getTrcTypeApprovedBy() + ", trcApprovalDate="
				+ trcApprovalDate + ", manufacturerCountry=" + manufacturerCountry + ", featureId=" + featureId
				...
				+ ", commsRadioInterp=" + commsRadioInterp + ", updateColumns=" + Arrays.toString(updateColumns) + "]";
	}
