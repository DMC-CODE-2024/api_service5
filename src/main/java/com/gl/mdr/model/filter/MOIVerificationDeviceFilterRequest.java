...
public class MOIVerificationDeviceFilterRequest {
	private Long id;
	...
	private String fileName,remarks,requestMode,requestType,province,district,commune,uploadedBy,deviceType;
	private String lang;
	...
	public String toString() {
		return "MOIVerificationDeviceFilterRequest [id=" + id + ", startDate=" + startDate + ", endDate=" + endDate
